      ...
      <transition name="fast-fade" mode="out-in">
        <div key="category">
          <portfolio-title
            ...
            :dataList="{ year, category: skillName }"
          />
          <div class="flex justify-center">
            <template v-show="computeSkills.length > 0">
              <nuxt-link
                v-for="skill in computeSkills"
                :key="skill.fields.id"
...
export default Vue.extend({
  ...
  computed: {
    ...
    computeSkills() {
      const skills = (this as any).skills;
